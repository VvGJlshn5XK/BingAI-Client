...
ConfigFile = open(str(os.path.dirname(os.path.abspath(__file__))) + '/config/server.json', 'r', encoding='utf-8')
ConfigJSON = json.loads(ConfigFile.read())
ConfigFile.close()

if ConfigJSON['AllowConnect']:
    HOST = '0.0.0.0'
else:
    HOST = '127.0.0.1'
PORT = int(ConfigJSON['Port'])
PROXY = ''
COOKIE_FILE_PATH = str(os.path.dirname(os.path.abspath(__file__))) + '/config/cookie.json'
print(ConfigJSON)
